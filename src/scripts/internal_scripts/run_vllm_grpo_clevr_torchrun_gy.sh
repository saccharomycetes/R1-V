...
# ==== 设置输出路径 ==== #
RUN_NAME="qwen_2_vl_7b_vllm_grpo_clevr_70k_gy_lr1e-6_bs1_ga2_ep2_torchrun_debug_20250213"
...
DS_CONFIG="/apdcephfs_cq8/share_1611098/ruanzheng/code/src/R1-V/src/open-r1-multimodal/local_scripts/zero2_no_optimizer.json"
