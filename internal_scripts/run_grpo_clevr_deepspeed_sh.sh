...
# ==== 设置输出路径 ==== #
RUN_NAME="qwen2_vl_2b_grpo_clevr_70k_debug_sh"
OUTPUT_DIR="/apdcephfs_cq8/share_1611098/ruanzheng/code/src/R1-V/output/${RUN_NAME}"
if [ ! -d "$OUTPUT_DIR" ]; then
    mkdir -p "$OUTPUT_DIR"
fi
# ==== 选择模型、数据集和deepspeed配置 ==== #
MODEL_NAME="/apdcephfs_sh8/share_301266059/stephenruan/code/src/Qwen2-VL-2B-Instruct"
# MODEL_NAME="/apdcephfs_sh8/share_301266059/stephenruan/code/src/Qwen2-VL-7B-Instruct"
DATASET_NAME="/apdcephfs_sh8/share_301266059/stephenruan/data/leonardPKU___clevr_cogen_a_train"
